...
Also big thanks to upkie team for providing the template for mpc balancer i ported it to mujoco for my RL training but you can simple change it to another simlator with minor tweeks but i hope this can be helpfull to anyone in need 
